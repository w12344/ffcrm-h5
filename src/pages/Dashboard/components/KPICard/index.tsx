...
import MainMetric from '@/components/KPICard/components/MainMetric';
import SubMetrics from '@/components/KPICard/components/SubMetrics';
import CircularChart, { MonthlyScoreChart } from '@/components/KPICard/components/CircularChart';
    ...
    <div className="kpi-card" onClick={(e) => handleMetricClick(e, title)}>
      <div className="left-content">
        <MainMetric
          ...
          onMetricClick={(t: string) => handleMetricClick({ stopPropagation: () => {} } as any, t)}
        />
